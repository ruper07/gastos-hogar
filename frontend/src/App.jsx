...
const DEFAULT_CATEGORIES = {
  ...
  mascota: { label:"Mascota (Enzo)", icon:"🐶", color:"#e8a020", subcats:["Veterinario","Alimento","Peluquería","Medicamentos","Accesorios","Otros"] }
};
...
function Dashboard({ expenses, categories }) {
  ...
  return (
    <div>
      ...
      {dashTab==="graficos"&&<MisGraficos expenses={expenses} categories={categories}/>}
